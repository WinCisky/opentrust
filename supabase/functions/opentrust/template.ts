...
const translationsIT: translation = {
  ...
  "You recently completed an order on ":
    "Hai completato di recente un ordine su ",
  " and we'd like to hear about your experience.":
    "e vorremmo sapere com'è andata.",
  "Click on&nbsp;<a href='https://opentrust.it/review/?order=":
    "Clicca su&nbsp;<a href='https://opentrust.it/review/it/?order=",
  "'><strong>this link</strong></a>&nbsp;to write about your experience.":
    "'><strong>questo link</strong></a>&nbsp;per raccontare la tua esperienza.",
...
<html>
    ...
    <body>
        <div class="content">
            ...
            <div class="row">
                <p>You need to setup a &nbsp;<a href="${SHOPIFY_WEBHOOK_GUIDE}"><strong>shopify webhook</strong></a>&nbsp; with the following URL: &nbsp;<strong>${
    ENDPOINT_URL + uuid
  }</strong></p>
            </div>
            <div class="row">
...
function reviewTemplateContent(
  ...
  return `
    ...
    <html>
        ...
        <body>
            <div class="content">
                ...
                <div class="row">
                    <p>${
    translateMe(locale, "You recently completed an order on ") + shopName +
    translateMe(locale, " and we'd like to hear about your experience.")
  }</p>
                </div>
                <div class="row">
                    <p>${
    translateMe(
      locale,
      "Click on&nbsp;<a href='https://opentrust.it/review/?order=",
    ) + orderId + "&name=" + encodeURIComponent(customerName) + "&shop=" +
