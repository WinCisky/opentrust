...
export class Const {
  static readonly urlSupabase = 
    "https://gjclmptpvaepykpghadl.functions.supabase.co";
  ...
  static readonly urlAuthPwd = "https://gjclmptpvaepykpghadl.functions.supabase.co/auth/v1/token?grant_type=password" 
}
